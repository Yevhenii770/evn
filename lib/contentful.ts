...
class ContentfulClient {
  ...
  private initializeContentful(): ContentfulClientApi {
    ...
    if (accessToken == null || accessToken == undefined) {
      throw new Error(
        "Environment variable CONTENTFUL_DELIVERY_ACCESS_TOKEN is required"
      );
    }
    ...
    if (environmentId == null || environmentId == undefined) {
      throw new Error(
        "Environment variable CONTENTFUL_ENVIRONMENT_ID is required"
      );
    }
    return createClient({
    ...
    return {
      aboutSectionContent: {
        ...
        headShot: {
          ...
          description:
            aboutContent.aboutSection.fields.headShot.fields.description,
    ...
    return {
      ...
      workBeforeAfter: workContent.workBeforeAfter.map(function (item: any) {
        return {
          ...
          beforeMedia: item.fields.beforeMedia.map(function (
            beforeMediaItem: any
          ) {
            return {
          ...
          afterMedia: item.fields.afterMedia.map(function (
            afterMediaItem: any
          ) {
            return {
    ...
    return [
      {
        ...
        stars: 5,
        review:
          "Yevhenii (EVN) has done several jobs for me, and for all jobs he was extremely professional, on time, and provided excellent work. The fan installation he did for me was quick and easy (for him) and he also helped but together a bedframe for me. I am 100% calling Yevhenii (EVN) for my next project.",
      },
      {
        firstName: "Krystal",
        stars: 5,
        review:
          "Yevhenii (EVN) was great! Very responsive and timely. He mounted a TV for me and hung numerous decorative wall items, including a very large mirror. All done with care and all done properly.  I will have many other needs in the future and I will certainly call Yevhenii (EVN). Highly recommend!",
      },
      {
        firstName: "Michael",
        stars: 5,
        review:
          "Yevhenii (EVN) was absolutely awesome. He did a great job of hanging wood carvings on a thin slab brick wall we have installed in our house and did a phenomenal job. He also helped with a couple other hanging projects. Extremely professional, very personable. I'll definitely be calling him again for any needs I have.",
      },
      {
        firstName: "Colin",
        stars: 5,
        review:
          "We have had Yevhenii (EVN) do several projects on my mom's house over the last year, and he has done an excellent job in completing each project in a timely manner with good quality. He's definitely not your typical handyman. His skills span into multiple trades including plumbing, electrical and carpentry, and he has really good availability and communication. We definitely recommend Yevhenii (EVN)!",
      },
      {
        firstName: "Sara",
        stars: 5,
        review:
          "Yevhenii (EVN) responded quickly to my message and scheduled the job within days. He did a great job for us. He knew exactly what parts were needed for the job and quickly made the repairs. He even checked in the following day to ensure everything was working properly. We will be calling him for all of our future home repairs/upgrades!",
      },
      {
        firstName: "Alex",
        stars: 5,
        review:
          "Contacted Yevhenii (EVN), he responded promptly and scheduled for when I was able to make it.  Yevhenii (EVN) got here on time, was very courteous, professional and clearly knew what he was doing.  The repairs were done in less time than estimated and the costs were adjusted accordingly.  The workmanship was top notch!  I am definitely going to use Yevhenii (EVN) for other jobs. Highly recommend!",
      },
      {
        firstName: "Jeanne",
        stars: 5,
        review:
          "Very professional, excellent work, highly recommend. He installed grab bars in our tiled shower and other items. He is a Class C contractor.",
      },
      {
        firstName: "Puneeth",
        stars: 5,
        review:
          "Yevhenii (EVN) did a fantastic job replacing garbage disposer, he is knowledgeable, affordable, on-time. His work is top-notch. Yevhenii (EVN) is now my go-to person when I am in need of a handyman.",
      },
      {
        firstName: "Bob",
        stars: 5,
        review:
          "Used Handyman Yevhenii (EVN) several times of household jobs. Always on time, did the job quickly and professionally. He is willing to make suggestions and I found his recommendations a better idea than my mine. He is friendly and very well organized. Rates are more than competitive. And importantly, I liked him. Recommend him without hesitation.",
      },
      {
        firstName: "Phillip",
        stars: 5,
        review:
          "5 star. HIGHLY RECOMMEND!!!.  Did a professional job and in a timely manner.   Very reasonable and neat.   I will definitely be calling Handyman Yevhenii (EVN) for future home projects.",
      },
      {
        firstName: "Christopher",
        stars: 5,
        review:
          "Quick, clean, and an honest professional. Something that had been on our to-do list since before we moved in was solved in an hour at an incredibly fair rate.",
      },
      {
        firstName: "Richard",
        stars: 5,
        review:
          "Yevhenii (EVN) did excellent work for me replacing an outdoor flood light. Will use him again and recommend him to neighbors.",
      },
      {
        firstName: "Robert",
        stars: 5,
        review:
          "Yevhenii (EVN) was on time and completed the repairs in minutes    In addition he followed up later to make sure things were working properly.  Just don’t see this type of quality service.  I will be calling him if I need anything.",
      },
      {
        firstName: "Lauren",
        stars: 5,
        review:
          "I would highly recommend Yevhenii (EVN) to get your job done.  He has been here several times in the last few weeks, hanging the TV, pictures, new light fixtures, shelves and more.  Each job was done professionally and with care.  He has a great deal of experience and makes certain to do each task properly.  He is now on my speed dial!!",
      },
      {
        firstName: "Tommy",
        stars: 5,
        review:
          "Very pleased with the professionalism and knowledge Yevhenii (EVN) displays on the job. Did a great job in a very timely manner",
      },
      {
        firstName: "Mary",
        stars: 5,
        review:
          "Yevhenii (EVN) was the best! He was responsive and got things done promptly. He removed an outdoor lamppost that had fallen over and replaced it with a new one. He put the new one in the ground with cement, tranferred the wiring, added the light fixture, and light bulbs and it works perfectly. We will definitely be using him in the future. Highly recommend!",
      },
      {
        firstName: "Matthew",
        stars: 5,
        review:
          "Yevhenii (EVN) can do it all and is timely and professional. Fair value!",
      },
      {
        firstName: "Cindy",
        stars: 5,
        review:
          "I am so glad to have found Yevhenii (EVN)! He is friendly, knowledgeable, informative and his work is top-notch. Yevhenii (EVN) is now my go-to person when I am in need of a handyman!",
      },
    ];
  }

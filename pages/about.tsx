      ...
      >
        ...
        >
          <Image
            ...
            placeholder="blur"
            blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAADElEQVR4nGPgyDMHAAEvAK4sH3esAA
"
          />
        </Box>
        <Typography paragraph>{props.aboutSectionContent.aboutText}</Typography>
      </Box>
    </SectionContainer>
  );
};

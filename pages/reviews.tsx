  ...
  return (
    <>
      ...
      <SectionContainer>
        ...
        >
          {documentToReactComponents(props.subHeader, {
            renderNode: {
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  try {
    const reviewsContent: ReviewContentfulContent =
      await contentfulClient.getReviewsContent();
    ...
    console.log(
      `error retrieving reviews content from contentful: ${e.message}`
    );
    throw e;
  }
};
